...
$(EXECUTABLE) : $(EXECUTABLE_ARMV7) $(EXECUTABLE_ARMV7S) $(EXECUTABLE_ARMV8) $(EXECUTABLE_I386)
	xcrun -sdk iphoneos lipo -output $@ -create -arch armv7 $(EXECUTABLE_ARMV7) -arch armv7s $(EXECUTABLE_ARMV7S) -arch arm64 $(EXECUTABLE_ARMV8) -arch i386 $(EXECUTABLE_I386)
...
$(SHARED_LIBRARY) : $(SHARED_LIBRARY_ARMV7) $(SHARED_LIBRARY_ARMV7S) $(SHARED_LIBRARY_ARMV8) $(SHARED_LIBRARY_I386)
	xcrun -sdk iphoneos lipo -output $@ -create -arch armv7 $(SHARED_LIBRARY_ARMV7) -arch armv7s $(SHARED_LIBRARY_ARMV7S) -arch arm64 $(SHARED_LIBRARY_ARMV8) -arch i386 $(SHARED_LIBRARY_I386)
...
$(STATIC_LIBRARY) : $(STATIC_LIBRARY_ARMV7) $(STATIC_LIBRARY_ARMV7S) $(STATIC_LIBRARY_ARMV8) $(STATIC_LIBRARY_I386)
	xcrun -sdk iphoneos lipo -output $@ -create -arch armv7 $(STATIC_LIBRARY_ARMV7) -arch armv7s $(STATIC_LIBRARY_ARMV7S) -arch arm64 $(STATIC_LIBRARY_ARMV8) -arch i386 $(STATIC_LIBRARY_I386)
...
#
clean:
	rm -rf $(EXECUTABLE) $(EXECUTABLE_ARMV7) $(EXECUTABLE_ARMV7S) $(EXECUTABLE_ARMV8) $(EXECUTABLE_I386)  $(STATIC_LIBRARY) $(STATIC_LIBRARY_ARMV7) $(STATIC_LIBRARY_ARMV7S) $(STATIC_LIBRARY_ARMV8) $(STATIC_LIBRARY_I386) $(PACKAGE) $(OBJECTS_ARMV7) $(OBJECTS_ARMV7S) $(OBJECTS_ARMV8) $(OBJECTS_I386) $(LOCAL_PATH)/.rlipo.*
