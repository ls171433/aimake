...
case ${OPERATION} in
install)
    echo ${INSTALL} ${INSTALL_FLAGS} -m 755 ${SRC_BIN_PATH}/${AIMAKE} ${TAR_BIN_PATH}/${AIMAKE}
    ${INSTALL} ${INSTALL_FLAGS} ${SRC_BIN_PATH}/${AIMAKE} ${TAR_BIN_PATH}/${AIMAKE}

    for FILE in ${AIMAKE_ETC}
    do
        echo ${INSTALL} ${INSTALL_FLAGS} -m 644 ${SRC_ETC_PATH}/${FILE} ${TAR_ETC_PATH}/${FILE}
        ${INSTALL} ${INSTALL_FLAGS} -m 644 ${SRC_ETC_PATH}/${FILE} ${TAR_ETC_PATH}/${FILE}
    done

    for FILE in ${AIMAKE_RES}
    do
        echo ${INSTALL} ${INSTALL_FLAGS} -m 644 ${SRC_RES_PATH}/${FILE} ${TAR_RES_PATH}/${FILE}
        ${INSTALL} ${INSTALL_FLAGS} -m 644 ${SRC_RES_PATH}/${FILE} ${TAR_RES_PATH}/${FILE}
    done
    ...
    do
        ...
        do
            echo ${INSTALL} ${INSTALL_FLAGS} -m 644 ${SRC_PLATFORM_PATH}/${PLATFORM}/${FILE} ${TAR_PLATFORM_PATH}/${PLATFORM}/${FILE}
            ${INSTALL} ${INSTALL_FLAGS} -m 644 ${SRC_PLATFORM_PATH}/${PLATFORM}/${FILE} ${TAR_PLATFORM_PATH}/${PLATFORM}/${FILE}
        done
    done
